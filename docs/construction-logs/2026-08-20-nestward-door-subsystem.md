...
diff --git a/docs/construction-logs/2026-08-20-nestward-door-subsystem.md b/docs/construction-logs/2026-08-20-nestward-door-subsystem.md
new file mode 100644
index 0000000..e6b1d12
--- /dev/null
+++ b/docs/construction-logs/2026-08-20-nestward-door-subsystem.md
@@ -0,0 +1,69 @@
...
+```
+
+Phone visual acceptance is intentionally pending because the new static candidates have not yet been compared with Vicky's satisfactory phone calibration. Nothing in this checkpoint is ready to merge to main or production.
+
+The local HTTP smoke check passed. Browser/device automation is unavailable in this workspace because no browser executable is installed, so this checkpoint makes no visual or iPhone acceptance claim.
