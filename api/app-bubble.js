...
const hubbyNoteAuthGuardScript = '<script src="/assets/hubby-note-auth-guard.js?v=20260610-auth-1"></script>';
...
(function(){
  function boot(){
    ...
    if(window.KittenNestHubbyNoteAuthGuard){
      window.KittenNestHubbyNoteAuthGuard.guard();
    }
