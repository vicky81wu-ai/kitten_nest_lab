...
const hotspotScript = '<script src="/assets/hotspot-positioner.js?v=20260612-note-hot-rotate-1"></script>';
const coordBoot = `
<script>
(function(){
  function boot(){
    ...
    var hotspotMode = q.get('hotspot') === '1' || path.indexOf('cloud-hotspot-test') >= 0 || path === '/cloud';
    if(hotspotMode){
