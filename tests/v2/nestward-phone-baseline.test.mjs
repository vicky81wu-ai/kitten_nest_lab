...
import { DOOR_AWAY_CALIBRATION, DOOR_CALIBRATION, SCENES, isBlocked, pointInsideHit } from '../../v2/nestward/world-model.js';
...
test('Naili’s Door Away indoor return anchor is a central clear floor point', () => {
  assert.deepEqual(DOOR_AWAY_CALIBRATION.nailiReturnAnchor, { x: 1220, z: .48 });
  assert.equal(isBlocked(SCENES.indoor, DOOR_AWAY_CALIBRATION.nailiReturnAnchor), false);
  assert.notDeepEqual(DOOR_AWAY_CALIBRATION.nailiReturnAnchor, DOOR_AWAY_CALIBRATION.point1);
});
