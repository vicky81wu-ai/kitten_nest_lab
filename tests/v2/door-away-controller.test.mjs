...
diff --git a/tests/v2/door-away-controller.test.mjs b/tests/v2/door-away-controller.test.mjs
new file mode 100644
index 0000000..32da145
--- /dev/null
+++ b/tests/v2/door-away-controller.test.mjs
@@ -0,0 +1,163 @@
...
+  assert.equal(h.commands.length, 6);
+  h.setClock(4);
+  h.controller.tick(4);
+  assert.equal(h.commands.at(-1).kind, 'exact');
