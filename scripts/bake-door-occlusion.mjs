...
diff --git a/scripts/bake-door-occlusion.mjs b/scripts/bake-door-occlusion.mjs
new file mode 100644
index 0000000..232f92d
--- /dev/null
+++ b/scripts/bake-door-occlusion.mjs
@@ -0,0 +1,260 @@
+#!/usr/bin/env node
+
...
+const outputs = {
+  maskA: path.join(outputDir, 'door-mask-a.candidate-v1.png'),
+  maskB: path.join(outputDir, 'door-mask-b.candidate-v1.png'),
+  walk: path.join(outputDir, 'door-walk.candidate-v1.png')
+};
+
+const hashes = {
